  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto relative z-10 space-y-8">
        <div className="inline-flex items-center gap-2.5 px-4 py-1 bg-[#181B1D] border border-[#B59A6A]/30 text-[11px] font-mono tracking-[0.22em] text-[#B59A6A] uppercase">
          <span>Private Appointments & Inquiries</span>
        </div>

        <h2 className="font-serif text-4xl sm:text-5xl md:text-7xl font-normal tracking-[0.04em] uppercase text-[#FAF9F6] leading-[1.08]">
          Your Next Address <br />
          <span className="italic font-serif text-[#B59A6A]">Starts Here.</span>
        </h2>

        <p className="font-sans text-base md:text-lg text-[#D8D3CA] font-light max-w-2xl mx-auto leading-relaxed">
