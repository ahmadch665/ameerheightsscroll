    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-[#D8D3CA] pb-6 mb-16 gap-4">
          <ScrollReveal as="div" direction="left" delay={0.00} className="flex items-center gap-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="pt-4 border-t border-[#D8D3CA] space-y-4">
              <ScrollReveal as="div" direction="up" delay={0.14} className="flex items-start gap-4">
              ...
              <ScrollReveal as="div" direction="up" delay={0.22} className="flex items-start gap-4">
                <div className="p-2 border border-[#B59A6A]/40 text-[#B59A6A] mt-1 shrink-0 bg-[#FAF9F6]">
        ...
        <div className="mt-20 pt-12 border-t border-[#D8D3CA] grid grid-cols-1 md:grid-cols-3 gap-8">
          <ScrollReveal as="div" direction="up" delay={0.06}>
          ...
          <ScrollReveal as="div" direction="up" delay={0.14}>
          ...
          <ScrollReveal as="div" direction="up" delay={0.22}>
