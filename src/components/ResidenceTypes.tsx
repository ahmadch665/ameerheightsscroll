...
export const ResidenceTypes: React.FC<ResidenceTypesProps> = ({ onSelectCategory, onOpenEnquiry }) => {
  return (
    <section
      id="residences"
      className="relative bg-[#181B1D] text-[#FAF9F6] py-28 md:py-36 px-6 md:px-16"
            ...
            >
              ...
              <div className="mt-10 pt-6 border-t border-[#242526] flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-3 py-1.5 text-[11px] font-mono tracking-wider uppercase text-[#B59A6A] hover:text-[#FAF9F6] hover:bg-[#B59A6A]/10 border border-[#B59A6A]/30 transition-colors"
                >
                  Enquire
                </button>
              </div>
